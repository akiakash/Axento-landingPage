...
import HiFidelity from "../../Assets/images/Hi-Fidelity.png";
...
const WhyAxento = () => {
  ...
  return (
    <div>
      <div className="w-full flex flex-col justify-center items-center text-[#fff] mt-24">
      ...
      <div className="w-full flex justify-center items-center gap-8 py-6 mt-6">
        ...
        >
          <div className="flex items-center justify-center h-full">
            <span className="text-[#fff] font-medium text-lg">Manage Task</span>
          </div>
        </div>
        ...
        >
          <div className="flex items-center justify-center h-full">
            <span className="text-[#fff] font-medium text-lg">AI-Powered</span>
          </div>
        </div>
        ...
        >
          <div className="flex items-center justify-center h-full">
            <span className="text-[#fff] font-medium text-lg">
              Productivity
            </span>
          </div>
        </div>
      ...
      <div className="w-full relative  h-[383px] overflow-hidden text-left text-5xl text-[#fff] font-inter mt-3">
        <div className="absolute top-[calc(50%_-_190.91px)] left-[calc(50%_-_600px)] rounded-2xl w-[600px] h-[400px] overflow-hidden">
          ...
          <div className="absolute top-[117px] left-[159px] w-[54%]">
            <Image src={HiFidelity} alt="Image" />
          </div>
          <div className="absolute top-[153px] left-[47px] w-[27%]">
            <Image src={Julian} alt="Image" />
          </div>
          <div className="absolute top-[153px] right-[6px] w-[27%]">
            <Image src={Henry} alt="Image" />
          </div>
          <div className="absolute bottom-[110px] left-[40px] text-3xl font-semibold">
            Manage Task
          </div>
          <div className="absolute bottom-[40px] left-[40px] text-[#fff] text-sm max-w-[400px]">
            <p>
